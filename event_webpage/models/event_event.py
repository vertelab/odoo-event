...
class EventEvent(models.Model):
        ...
        empty_description= fields.Text(default=" ", string="Is used for the description view since we want it to be empty, and if I remove it the formating breaks,so we have this useless empty string, go team!")
